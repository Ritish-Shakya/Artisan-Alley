...
if (isset($_SESSION['username'])) {
    ...
    while ($row = mysqli_fetch_assoc($query_result)) {
        ...
        $order_query = "INSERT INTO order_details(product_id,customer_id,qty,payment_status,order_status,ordered_date)values('$product_id','$user_id','$quantity','$payment_type','Pending','$today_date')";
        echo($order_query);
